...
Version  : 2.9.93
Release  : 22
URL      : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.9.93.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.9.93.tar.gz
...
%prep
%setup -q -n libpinyin-2.9.93
cd %{_builddir}/libpinyin-2.9.93
pushd ..
cp -a libpinyin-2.9.93 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735403536
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.9.93/novel_types.h
/usr/include/libpinyin-2.9.93/pinyin.h
/usr/include/libpinyin-2.9.93/pinyin_custom2.h
