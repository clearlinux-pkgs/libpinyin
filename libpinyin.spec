...
/usr/lib64/libpinyin/data/scitech.bin
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-0.9.93/novel_types.h
/usr/include/libpinyin-0.9.93/pinyin.h
/usr/include/libpinyin-0.9.93/pinyin_custom2.h
/usr/lib64/libpinyin.so
/usr/lib64/pkgconfig/libpinyin.pc

%files lib
%defattr(-,root,root,-)
/usr/lib64/libpinyin.so.4
