...
Version  : 2.8.0
Release  : 17
URL      : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.8.0.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.8.0.tar.gz
...
%prep
%setup -q -n libpinyin-2.8.0
cd %{_builddir}/libpinyin-2.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672847103
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.8.0/novel_types.h
/usr/include/libpinyin-2.8.0/pinyin.h
/usr/include/libpinyin-2.8.0/pinyin_custom2.h
