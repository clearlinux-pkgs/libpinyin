...
Version  : 2.10.1
Release  : 24
URL      : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.10.1.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.10.1.tar.gz
...
%prep
%setup -q -n libpinyin-2.10.1
cd %{_builddir}/libpinyin-2.10.1
pushd ..
cp -a libpinyin-2.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742825702
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.10.1/novel_types.h
/usr/include/libpinyin-2.10.1/pinyin.h
/usr/include/libpinyin-2.10.1/pinyin_custom2.h
