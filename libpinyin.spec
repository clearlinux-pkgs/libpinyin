...
Version  : 2.8.1
Release  : 18
URL      : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.8.1.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.8.1.tar.gz
...
%prep
%setup -q -n libpinyin-2.8.1
cd %{_builddir}/libpinyin-2.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673887671
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.8.1/novel_types.h
/usr/include/libpinyin-2.8.1/pinyin.h
/usr/include/libpinyin-2.8.1/pinyin_custom2.h
