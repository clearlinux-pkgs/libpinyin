...
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.10.2.tar.gz
...
%prep
%setup -q -n libpinyin-2.10.2
cd %{_builddir}/libpinyin-2.10.2
pushd ..
cp -a libpinyin-2.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747404825
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.10.2/novel_types.h
/usr/include/libpinyin-2.10.2/pinyin.h
/usr/include/libpinyin-2.10.2/pinyin_custom2.h
