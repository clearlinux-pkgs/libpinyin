...
Version  : 2.9.92
Release  : 21
URL      : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.9.92.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.9.92.tar.gz
...
%prep
%setup -q -n libpinyin-2.9.92
cd %{_builddir}/libpinyin-2.9.92
pushd ..
cp -a libpinyin-2.9.92 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729887508
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.9.92/novel_types.h
/usr/include/libpinyin-2.9.92/pinyin.h
/usr/include/libpinyin-2.9.92/pinyin_custom2.h
