...
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.6.2.tar.gz
...
%prep
%setup -q -n libpinyin-2.6.2
cd %{_builddir}/libpinyin-2.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649861038
...
cp %{_builddir}/libpinyin-2.6.2/COPYING %{buildroot}/usr/share/package-licenses/libpinyin/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.6.2/novel_types.h
/usr/include/libpinyin-2.6.2/pinyin.h
/usr/include/libpinyin-2.6.2/pinyin_custom2.h
