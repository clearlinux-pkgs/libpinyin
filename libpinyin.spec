...
Version  : 2.9.91
Release  : 20
URL      : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.9.91.tar.gz
Source0  : https://sourceforge.net/projects/libpinyin/files/libpinyin/libpinyin-2.9.91.tar.gz
...
%prep
%setup -q -n libpinyin-2.9.91
cd %{_builddir}/libpinyin-2.9.91
pushd ..
cp -a libpinyin-2.9.91 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723560246
...
%files dev
%defattr(-,root,root,-)
/usr/include/libpinyin-2.9.91/novel_types.h
/usr/include/libpinyin-2.9.91/pinyin.h
/usr/include/libpinyin-2.9.91/pinyin_custom2.h
